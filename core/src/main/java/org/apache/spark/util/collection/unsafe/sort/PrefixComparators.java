...
/***
 * The key prefixes are generated by the user when inserting records into the sorter(UnsafeExternalRowSorter#insertRow), which uses a user-defined comparison function for comparing them
 */
@Private
